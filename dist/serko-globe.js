...
void main() {
    ...
    `}),p=new Os(_,v);return p.frustumCulled=!1,p.renderOrder=2,p.userData.stats={count:l,landCount:f},p}function Hr({color:n=1315866,opacity:e=.13,latStep:t=10,lngStep:A=10,latLimit:i=80,segments:r=128}={}){const s=[],a=new U,o=(d,f)=>{FA(d,f,1.0005,a),s.push(a.x,a.y,a.z)};for(let d=-i;d<=i;d+=t)for(let f=0;f<r;f++)o(d,-180+f/r*360),o(d,-180+(f+1)/r*360);for(let d=-180;d<180;d+=A)for(let f=0;f<r;f++)o(-90+f/r*180,d),o(-90+(f+1)/r*180,d);const l=new yt;l.setAttribute("position",new ot(new Float32Array(s),3));const u=new Nt({transparent:!0,depthWrite:!1,uniforms:{uColor:{value:new ze(n)},uOpacity:{value:e},uCamDir:{value:new U(0,0,1)},uFadeStart:{value:.1}},vertexShader:`
      uniform vec3 uCamDir;
      varying float vFacing;
      void main() {
        vFacing = dot(normalize(position), uCamDir);
    ...
    `}),h=new Fs(l,u);return h.frustumCulled=!1,h.renderOrder=1,h}function Qc({color:n=1315866,opacity:e=.28,segments:t=512}={}){const A=new Float32Array(t*3);for(let o=0;o<t;o++){const l=o/t*Math.PI*2;A[o*3]=Math.cos(l),A[o*3+1]=Math.sin(l),A[o*3+2]=0}const i=new yt;i.setAttribute("position",new ot(A,3));const r=new Zi({color:n,transparent:!0,opacity:e,depthWrite:!1}),s=new Ns(i,r);s.frustumCulled=!1,s.renderOrder=3;const a=new U(0,0,1);return s.userData.faceCamera=o=>{s.quaternion.setFromUnitVectors(a,o)},s}function Jc(n){const e=n.length,t=new Float32Array(e*2*3),A=new Float32Array(e*2*3),i=new Float32Array(e*2*3),r=new Float32Array(e*2),s=new Float32Array(e*2);for(let l=0;l<e;l++){const u=n[l],h=n[Math.max(l-1,0)],d=n[Math.min(l+1,e-1)],f=e===1?0:l/(e-1);for(let _=0;_<2;_++){const v=(l*2+_)*3;t[v]=u.x,t[v+1]=u.y,t[v+2]=u.z,A[v]=h.x,A[v+1]=h.y,A[v+2]=h.z,i[v]=d.x,i[v+1]=d.y,i[v+2]=d.z,r[l*2+_]=_===0?-1:1,s[l*2+_]=f}}const a=new Uint32Array((e-1)*6);for(let l=0;l<e-1;l++){const u=l*2,h=l*6;a[h]=u,a[h+1]=u+1,a[h+2]=u+2,a[h+3]=u+2,a[h+4]=u+1,a[h+5]=u+3}const o=new yt;return o.setAttribute("position",new ot(t,3)),o.setAttribute("aPrev",new ot(A,3)),o.setAttribute("aNext",new ot(i,3)),o.setAttribute("aSide",new ot(r,1)),o.setAttribute("aAlong",new ot(s,1)),o.setIndex(new ot(a,1)),o}const eu=`
...
`;let kr=!1;function fu(n){if(kr)return;kr=!0;const e=n.createElement("style");e.textContent=du,n.head.appendChild(e)}function pu(n){fu(document);const e=document.createElement("div");return e.className="globe-pin-layer",Object.assign(e.style,{position:"absolute",inset:"0",pointerEvents:"none",zIndex:"40",overflow:"hidden"}),n.root.appendChild(e),e}class Wr{constructor(e,t){this.place=t,this.el=document.createElement("div"),this.el.className="globe-pin";const A=document.createElement("div");A.className="globe-pin__pill",A.textContent=t.label;const i=document.createElement("div");i.className="globe-pin__stem";const r=document.createElement("div");r.className="globe-pin__dot",this.el.append(A,i,r),this.pill=A,this.stem=i,this.dot=r,e.appendChild(this.el),this._amount=0,this.setAmount(0)}setAmount(e){return this._amount=Math.min(1,Math.max(0,e)),this}update(e){const t=e.project(this.place.lat,this.place.lng),A=this._amount;if(!t.visible||A<=.001){this.el.style.opacity="0";return}const i=Math.min(1,t.depth/.12);this.el.style.opacity=String(A*i),this.el.style.transform=`translate(${t.x}px, ${t.y}px)`;const r=1-A;this.pill.style.transform=`translateX(-50%) translateY(${r*10}px)`,this.pill.style.opacity=String(Math.min(1,A*1.4)),this.stem.style.transform=`scaleY(${A})`,this.dot.style.transform=`scale(${.4+.6*A})`}dispose(){this.el.remove()}}const mu=new Set(["IMG","SVG","PICTURE","VIDEO","CANVAS"]);function _u(n){return n.hasAttribute("data-type-atom")||mu.has(n.tagName.toUpperCase())?!0:n.textContent.trim()===""}function gu(n){const e=[];for(let t=1;t<=n.length;t++)e.push(t);return e}function vu(n){const e=[],t=/\S+/g;let A;for(;(A=t.exec(n))!==null;)e.push(A.index+A[0].length);return!e.length&&n.length&&e.push(n.length),e}function Xr(n,e,t){for(const A of Array.from(n.childNodes)){if(A.nodeType===Node.TEXT_NODE){const i=A.nodeValue;if(i.trim()===""||t.skip(A.parentElement))continue;const r=t.byWord?vu(i):gu(i);e.push({kind:"text",node:A,text:i,steps:r,cost:r.length});continue}A.nodeType===Node.ELEMENT_NODE&&(t.skip(A)||(_u(A)?e.push({kind:"atom",el:A,cost:t.atomCost,display:A.style.display}):Xr(A,e,t)))}}class xu{constructor(e,{skipSelector:t=null,byWord:A=!1}={}){this.el=e,this.byWord=A;const i=t?Array.from(e.querySelectorAll(t)):[],r=s=>s?i.some(a=>a===s||a.contains(s)):!1;this.units=[],Xr(e,this.units,{skip:r,byWord:A,atomCost:A?1:4}),this.total=this.units.reduce((s,a)=>s+a.cost,0),this.revealed=-1,this.reveal(0)}reveal(e){if(e===this.revealed)return;this.revealed=e;let t=e;for(const A of this.units){if(A.kind==="text"){const i=Math.max(0,Math.min(A.steps.length,t)),r=i===0?0:A.steps[i-1],s=A.text.slice(0,r);A.node.nodeValue!==s&&(A.node.nodeValue=s)}else{const i=t>=A.cost?A.display||"":"none";A.el.style.display!==i&&(A.el.style.display=i)}t-=A.cost}}get done(){return this.revealed>=this.total}}const Mu=.6;function qr(n,e,t){const A=n.getAttribute(e);if(A===null||A.trim()==="")return t;const i=A.split(",").map(r=>Number.parseFloat(r.trim())).filter(r=>Number.isFinite(r));return i.length?i:t}function NA(n,e,t){const A=n.getAttribute(e);if(A===null||A.trim()==="")return t;const i=Number.parseFloat(A);return Number.isFinite(i)?i:t}const In=n=>n<0?0:n>1?1:n,Yr=n=>1-Math.pow(1-n,3),Su=n=>1+(1.70158+1)*Math.pow(n-1,3)+1.70158*Math.pow(n-1,2);function Eu(n){const e=n.hasAttribute("data-globe-pin"),t=(n.getAttribute("data-anim")||"fade").toLowerCase(),A={el:n,anchored:e,anim:t,lat:NA(n,"data-lat",0),lng:NA(n,"data-lng",0),offsetX:NA(n,"data-offset-x",0),offsetY:NA(n,"data-offset-y",0),ins:qr(n,"data-in",[0]),outs:n.hasAttribute("data-out")?qr(n,"data-out",[]):[],collapse:(n.getAttribute("data-collapse")||"true").toLowerCase()!=="false",dur:NA(n,"data-dur",Mu),typeSpeed:NA(n,"data-type-speed",26),typer:null,strokes:null,exitWidth:null,baseMinWidth:"",baseMaxWidth:"",typedCount:-1,hiddenByDisplay:!1,revealDisplay:""};if(t==="type"){const r=n.getBoundingClientRect();r.height&&(n.style.minHeight=`${Math.ceil(r.height)}px`),r.width&&(n.style.minWidth=`${Math.ceil(r.width)}px`,n.style.maxWidth="100%");const s=(n.getAttribute("data-type-by")||"word").toLowerCase()!=="char";A.typer=new xu(n,{skipSelector:n.getAttribute("data-type-skip")||null,byWord:s}),n.hasAttribute("data-type-speed")||(A.typeSpeed=s?4.5:26)}if(t==="draw"){const r=n.getAttribute("data-draw-target")||"path";A.strokes=Array.from(n.querySelectorAll(r)).filter(s=>typeof s.getTotalLength=="function").map(s=>{let a=0;try{a=s.getTotalLength()}catch{a=0}return a?(s.style.strokeDasharray=String(a),s.style.strokeDashoffset=String(a),{path:s,length:a}):null}).filter(Boolean)}const i=typeof getComputedStyle=="function"?getComputedStyle(n):null;return i&&i.display==="none"&&(A.hiddenByDisplay=!0,A.revealDisplay=n.getAttribute("data-display")||"block"),n.style.willChange="transform, opacity",e&&(n.style.position="absolute",n.style.top="0",n.style.left="0"),A}function yu(n,e){let t=-1;for(let A=0;A<n.ins.length;A++)e>=n.ins[A]&&(t=A);return t<0?{index:-1,start:n.ins[0]??0,end:n.outs[0]??null}:{index:t,start:n.ins[t],end:n.outs[t]===void 0?null:n.outs[t]}}class Tu{constructor(e,t=document){const A=t.querySelectorAll("[data-globe-cue], [data-globe-pin]");this.items=Array.from(A).map(Eu),this.stage=e}get maxTime(){return this.items.reduce((e,t)=>{const A=t.ins[t.ins.length-1],i=t.outs.length?t.outs[t.outs.length-1]:null,r=Math.max(A,i===null?0:i)+t.dur,s=t.typer?A+t.typer.total/t.typeSpeed:0;return Math.max(e,r,s)},0)}update(e,t){for(const A of this.items)this._updateItem(A,e,t)}_updateItem(e,t,A){const i=yu(e,t),r=i.index<0?0:In((t-i.start)/e.dur),s=i.end===null?0:In((t-i.end)/e.dur),a=r*(1-s),o=e.el;e.anim==="type"&&this._type(e,t,i.start),e.anim==="draw"&&this._draw(e,r);const l=i.end!==null&&t>=i.end+e.dur;if(e.collapse&&i.end!==null&&(s>0&&s<1?(e.exitWidth===null&&(e.exitWidth=o.offsetWidth,e.baseMinWidth=o.style.minWidth,e.baseMaxWidth=o.style.maxWidth,o.style.overflow="hidden",o.style.whiteSpace="nowrap"),o.style.minWidth="0px",o.style.maxWidth=`${e.exitWidth*(1-s)}px`):s===0&&e.exitWidth!==null&&(o.style.minWidth=e.baseMinWidth,o.style.maxWidth=e.baseMaxWidth,o.style.overflow="",o.style.whiteSpace="",e.exitWidth=null)),a<=.001){o.style.opacity="0",o.style.pointerEvents="none",(e.hiddenByDisplay||l&&e.collapse)&&(o.style.display="none");return}const u=e.hiddenByDisplay?e.revealDisplay:"";o.style.display!==u&&(o.style.display=u);let h=a,d=e.offsetX,f=e.offsetY,_=1;if(e.anim==="rise"?f+=(1-Yr(r))*16:e.anim==="pop"?(_=.86+.14*Su(r),h=In(r*1.6)*(1-s)):(e.anim==="type"||e.anim==="draw")&&(h=r>0?1-s:0),e.anchored){const v=A.project(e.lat,e.lng);if(!v.visible){o.style.opacity="0",e.hiddenByDisplay&&(o.style.display="none");return}const p=Math.min(1,v.depth/.12);h*=p,o.style.transform=`translate(${v.x+d}px, ${v.y+f}px) translate(-50%, -100%) scale(${_})`}else o.style.transform=`translate(${d}px, ${f}px) scale(${_})`;o.style.opacity=String(h),o.style.pointerEvents=h>.9?"":"none"}_draw(e,t){if(!e.strokes||!e.strokes.length)return;const A=Yr(In(t));for(const i of e.strokes)i.path.style.strokeDashoffset=String(i.length*(1-A))}_type(e,t,A){if(!e.typer)return;const i=t-A,r=i<=0?0:Math.min(e.typer.total,Math.floor(i*e.typeSpeed));r!==e.typedCount&&(e.typedCount=r,e.typer.reveal(r),e.el.dataset.typing=e.typer.done?"0":"1")}}const $r=[{selector:".hero1_profile_choice_wrap",in:.2,anim:"rise"},{selector:".hero1_profile_choice_text_wrap",in:.6,out:6.2,dur:.45,anim:"type",typeSpeed:4.5},{selector:".hero1_profile_search_wrap",in:[.2,11.5],out:[6.2],dur:.45,anim:"fade"},{selector:".hero1_profile_route_wrap",in:3.2,out:8.4,dur:.5,anim:"rise"},{selector:".hero1_profile_choice_check",in:6.7,out:11,dur:.4,anim:"pop",display:"flex"},{selector:".hero1_profile_choice_check_mark",in:[6.85,8.9],dur:.5,anim:"draw",optional:!0},{selector:".hero1_profile_choice_confirm",create:{cloneFrom:".hero1_profile_choice_text",insertAfter:".hero1_profile_choice_check",text:"No early mornings",style:{marginLeft:"4px",marginRight:"auto",textAlign:"left",flex:"0 0 auto"}},in:7,out:8.6,dur:.4,anim:"type",typeSpeed:4.5,display:"block",optional:!0},{selector:".hero1_profile_choice_confirm_two",create:{cloneFrom:".hero1_profile_choice_text",insertAfter:".hero1_profile_choice_check",text:"Premium economy",style:{marginLeft:"4px",marginRight:"auto",textAlign:"left",flex:"0 0 auto"}},in:9.1,out:11,dur:.4,anim:"type",typeSpeed:4.5,display:"block",optional:!0},{selector:".hero1_profile_choice_prompt_two",in:11.7,anim:"type",typeSpeed:4.5,display:"flex",optional:!0},{selector:".hero1_profile_choice_line",in:14,stagger:1.6,anim:"type",typeSpeed:4.5,display:"flex",optional:!0}],wu=3,bu={in:"data-in",out:"data-out",dur:"data-dur",anim:"data-anim",typeSpeed:"data-type-speed",typeSkip:"data-type-skip",typeBy:"data-type-by",display:"data-display",lat:"data-lat",lng:"data-lng",offsetX:"data-offset-x",offsetY:"data-offset-y"};function Ru(n,e){const{cloneFrom:t,appendTo:A,insertAfter:i,text:r,style:s}=n.create,a=A?e.querySelector(A):null,o=i?e.querySelector(i):null;if(!a&&!o)return null;const l=t?e.querySelector(t):null,u=l?l.cloneNode(!1):(e.ownerDocument||document).createElement("div");u.removeAttribute("data-globe-cue"),u.removeAttribute("data-globe-pin");for(const h of n.selector.split(".").filter(Boolean))u.classList.add(h);return r!==void 0&&(u.textContent=r),s&&Object.assign(u.style,s),u.style.display="none",o&&o.parentNode?o.parentNode.insertBefore(u,o.nextSibling):a.appendChild(u),u}function Pu(n=$r,e=document){const t=[],A=[],i=[];for(const r of n){let s=e.querySelectorAll(r.selector);if(!s.length&&r.create){const o=Ru(r,e);o&&(s=[o],i.push(r.selector))}if(!s.length){r.optional||A.push(r.selector);continue}let a=0;for(const o of s){const l=r.stagger?a*r.stagger:0;a++;const u=r.lat!==void 0?"data-globe-pin":"data-globe-cue";!o.hasAttribute("data-globe-cue")&&!o.hasAttribute("data-globe-pin")&&o.setAttribute(u,"");for(const[h,d]of Object.entries(bu)){if(r[h]===void 0||o.hasAttribute(d))continue;const f=p=>Math.round((p+l)*1e3)/1e3,_=r[h],v=h==="in"||h==="out"?Array.isArray(_)?_.map(f).join(","):f(_):_;o.setAttribute(d,String(v))}t.push(r.selector)}}return A.length&&console.warn("[globe] sequence selectors matched nothing: "+A.join(", ")+" - a class was probably renamed in Webflow"),{applied:t,missing:A,created:i}}const jr={linear:n=>n,outCubic:n=>1-Math.pow(1-n,3),inOutCubic:n=>n<.5?4*n*n*n:1-Math.pow(-2*n+2,3)/2,outBack:n=>1+(1.70158+1)*Math.pow(n-1,3)+1.70158*Math.pow(n-1,2)},Du=[{track:"originPin",at:.15,dur:.75,from:0,to:1,ease:"outBack"},{track:"arcDraw",at:.65,dur:1.5,from:0,to:1,ease:"inOutCubic"},{track:"destPin",at:2.05,dur:.75,from:0,to:1,ease:"outBack"},{track:"dropHead",at:2.6,dur:1.8,from:0,to:1,ease:"inOutCubic"}];class Cu{constructor({route:e,originPin:t,destPin:A,beats:i=Du,offset:r=0,loop:s=!1,loopDelay:a=2.5}){this.route=e,this.originPin=t,this.destPin=A,this.offset=r,this.beats=r?i.map(o=>({...o,at:o.at+r})):i,this.loop=s,this.loopDelay=a,this.time=0,this.playing=!1,this.duration=this.beats.reduce((o,l)=>Math.max(o,l.at+l.dur),0),this.values={originPin:0,arcDraw:0,dropHead:0,destPin:0},this._apply()}play(){return this.playing=!0,this}pause(){return this.playing=!1,this}restart(){return this.time=0,this.playing=!0,this}seek(e){return this.time=e,this._sample(),this._apply(),this}complete(){return this.seek(this.duration)}advance(e){if(!this.playing)return this;this.time+=e;const t=this.duration+(this.loop?this.loopDelay:0);return this.time>t&&(this.loop?this.time=0:this.time=this.duration),this._sample(),this._apply(),this}_sample(){for(const e of this.beats){const t=(this.time-e.at)/e.dur,A=Math.min(1,Math.max(0,t)),i=jr[e.ease]||jr.linear;this.values[e.track]=e.from+(e.to-e.from)*i(A)}}_apply(){const e=this.values;this.route.setProgress(e.arcDraw),this.route.setHead(e.dropHead),this.originPin&&this.originPin.setAmount(e.originPin),this.destPin&&this.destPin.setAmount(e.destPin)}}function Lu(){return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const Kr="#globe-root";function Zr(){const n=document.querySelector(Kr);if(!n){console.warn(`[globe] no ${Kr} on the page`);return}if(n.dataset.globeMounted)return;n.dataset.globeMounted="1";const e=cu(n),t=lu(n),A=new ou(n,e),i=t[0],r=t[1];let s=null;if(i&&r){const o=A.addRoute(i,r),l=pu(A),u=new Wr(l,i),h=new Wr(l,r);s=new Cu({route:o,originPin:u,destPin:h,offset:e.globeStart||wu,loop:n.hasAttribute("data-globe-loop")}),Pu($r,document);const d=new Tu(A,document);d.maxTime>s.duration&&(s.duration=d.maxTime),A.onFrame((f,_)=>{s.advance(_.deltaSeconds),u.update(_),h.update(_),d.update(s.time,_)}),window.__globeOverlays=d,Lu()?s.complete():s.play()}A.start(),(new URLSearchParams(location.search).has("debug")||n.hasAttribute("data-globe-debug"))&&hu(A),window.__globe={stage:A,layout:e,places:t,flow:s}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Zr,{once:!0}):Zr()})();
