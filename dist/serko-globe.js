...
`)+`
`+h);const E=b+f+s,y=b+h+a,R=$r(i,i.VERTEX_SHADER,E),T=$r(i,i.FRAGMENT_SHADER,y);i.attachShader(_,R),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(D){if(n.debug.checkShaderErrors){const O=i.getProgramInfoLog(_)||"",G=i.getShaderInfoLog(R)||"",q=i.getShaderInfoLog(T)||"",Y=O.trim(),W=G.trim(),J=q.trim();let H=!0,rt=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(H=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(i,_,R,T);else{const ht=Kr(i,R,"vertex"),nt=Kr(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
