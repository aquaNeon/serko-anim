...
void main() {
    ...
    `}),u=new Os(o,h);return u.frustumCulled=!1,u.renderOrder=1,u}function Au({color:n=1315866,opacity:t=.28,segments:e=512}={}){const A=new Float32Array(e*3);for(let l=0;l<e;l++){const o=l/e*Math.PI*2;A[l*3]=Math.cos(o),A[l*3+1]=Math.sin(o),A[l*3+2]=0}const i=new we;i.setAttribute("position",new oe(A,3));const r=new er({color:n,transparent:!0,opacity:t,depthWrite:!1}),s=new zs(i,r);s.frustumCulled=!1,s.renderOrder=3;const a=new U(0,0,1);return s.userData.faceCamera=l=>{s.quaternion.setFromUnitVectors(a,l)},s}function nu(n){const t=n.length,e=new Float32Array(t*2*3),A=new Float32Array(t*2*3),i=new Float32Array(t*2*3),r=new Float32Array(t*2),s=new Float32Array(t*2);for(let o=0;o<t;o++){const h=n[o],u=n[Math.max(o-1,0)],d=n[Math.min(o+1,t-1)],p=t===1?0:o/(t-1);for(let m=0;m<2;m++){const _=(o*2+m)*3;e[_]=h.x,e[_+1]=h.y,e[_+2]=h.z,A[_]=u.x,A[_+1]=u.y,A[_+2]=u.z,i[_]=d.x,i[_+1]=d.y,i[_+2]=d.z,r[o*2+m]=m===0?-1:1,s[o*2+m]=p}}const a=new Uint32Array((t-1)*6);for(let o=0;o<t-1;o++){const h=o*2,u=o*6;a[u]=h,a[u+1]=h+1,a[u+2]=h+2,a[u+3]=h+2,a[u+4]=h+1,a[u+5]=h+3}const l=new we;return l.setAttribute("position",new oe(e,3)),l.setAttribute("aPrev",new oe(A,3)),l.setAttribute("aNext",new oe(i,3)),l.setAttribute("aSide",new oe(r,1)),l.setAttribute("aAlong",new oe(s,1)),l.setIndex(new oe(a,1)),l}const iu=`
