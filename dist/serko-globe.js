...
#endif`;const Ue={alphahash_fragment:Hs,alphahash_pars_fragment:Gs,alphamap_fragment:Vs,alphamap_pars_fragment:ks,alphatest_fragment:Ws,alphatest_pars_fragment:Xs,aomap_fragment:qs,aomap_pars_fragment:Ys,batching_pars_vertex:$s,batching_vertex:js,begin_vertex:Ks,beginnormal_vertex:Zs,bsdfs:Qs,iridescence_fragment:Js,bumpmap_pars_fragment:ea,clipping_planes_fragment:ta,clipping_planes_pars_fragment:Aa,clipping_planes_pars_vertex:na,clipping_planes_vertex:ia,color_fragment:ra,color_pars_fragment:sa,color_pars_vertex:aa,color_vertex:oa,common:la,cube_uv_reflection_fragment:ca,defaultnormal_vertex:ua,displacementmap_pars_vertex:ha,displacementmap_vertex:da,emissivemap_fragment:fa,emissivemap_pars_fragment:pa,colorspace_fragment:ma,colorspace_pars_fragment:_a,envmap_fragment:ga,envmap_common_pars_fragment:va,envmap_pars_fragment:xa,envmap_pars_vertex:Ma,envmap_physical_pars_fragment:La,envmap_vertex:Sa,fog_vertex:Ea,fog_pars_vertex:Ta,fog_fragment:ya,fog_pars_fragment:wa,gradientmap_pars_fragment:ba,lightmap_pars_fragment:Ra,lights_lambert_fragment:Pa,lights_lambert_pars_fragment:Da,lights_pars_begin:Ca,lights_toon_fragment:Ia,lights_toon_pars_fragment:Ua,lights_phong_fragment:Fa,lights_phong_pars_fragment:Na,lights_physical_fragment:Ba,lights_physical_pars_fragment:Oa,lights_fragment_begin:za,lights_fragment_maps:Ha,lights_fragment_end:Ga,logdepthbuf_fragment:Va,logdepthbuf_pars_fragment:ka,logdepthbuf_pars_vertex:Wa,logdepthbuf_vertex:Xa,map_fragment:qa,map_pars_fragment:Ya,map_particle_fragment:$a,map_particle_pars_fragment:ja,metalnessmap_fragment:Ka,metalnessmap_pars_fragment:Za,morphinstance_vertex:Qa,morphcolor_vertex:Ja,morphnormal_vertex:eo,morphtarget_pars_vertex:to,morphtarget_vertex:Ao,normal_fragment_begin:no,normal_fragment_maps:io,normal_pars_fragment:ro,normal_pars_vertex:so,normal_vertex:ao,normalmap_pars_fragment:oo,clearcoat_normal_fragment_begin:lo,clearcoat_normal_fragment_maps:co,clearcoat_pars_fragment:uo,iridescence_pars_fragment:ho,opaque_fragment:fo,packing:po,premultiplied_alpha_fragment:mo,project_vertex:_o,dithering_fragment:go,dithering_pars_fragment:vo,roughnessmap_fragment:xo,roughnessmap_pars_fragment:Mo,shadowmap_pars_fragment:So,shadowmap_pars_vertex:Eo,shadowmap_vertex:To,shadowmask_pars_fragment:yo,skinbase_vertex:wo,skinning_pars_vertex:bo,skinning_vertex:Ro,skinnormal_vertex:Po,specularmap_fragment:Do,specularmap_pars_fragment:Co,tonemapping_fragment:Lo,tonemapping_pars_fragment:Io,transmission_fragment:Uo,transmission_pars_fragment:Fo,uv_pars_fragment:No,uv_pars_vertex:Bo,uv_vertex:Oo,worldpos_vertex:zo,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	`}function Ko(n){let e=new WeakMap,t=null;function A(a){if(a&&a.isTexture){const l=a.mapping,o=l===303||l===304,u=l===301||l===302;if(o||u){let h=e.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new dr(n)),h=o?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return o&&f&&f.height>0||u&&f&&i(f)?(t===null&&(t=new dr(n)),h=o?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function i(a){let l=0;const o=6;for(let u=0;u<o;u++)a[u]!==void 0&&l++;return l===o}function r(a){const l=a.target;l.removeEventListener("dispose",r);const o=e.get(l);o!==void 0&&(e.delete(l),o.dispose())}function s(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:A,dispose:s}}function Zo(n){const e={};function t(A){if(e[A]!==void 0)return e[A];let i;switch(A){case"WEBGL_depth_texture":i=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=n.getExtension(A)}return e[A]=i,i}return{has:function(A){return t(A)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(A){const i=t(A);return i===null&&HA("THREE.WebGLRenderer: "+A+" extension not supported."),i}}}function Qo(n,e,t,A){const i={},r=new WeakMap;function s(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);d.removeEventListener("dispose",s),delete i[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),A.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return i[d.id]===!0||(d.addEventListener("dispose",s),i[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const f in d)e.update(d[f],n.ARRAY_BUFFER)}function o(h){const d=[],f=h.index,_=h.attributes.position;let v=0;if(f!==null){const w=f.array;v=f.version;for(let y=0,E=w.length;y<E;y+=3){const D=w[y+0],b=w[y+1],C=w[y+2];d.push(D,b,b,C,C,D)}}else if(_!==void 0){const w=_.array;v=_.version;for(let y=0,E=w.length/3-1;y<E;y+=3){const D=y+0,b=y+1,C=y+2;d.push(D,b,b,C,C,D)}}else return;const p=new(Ti(d)?Gi:Hi)(d,1);p.version=v;const c=r.get(h);c&&e.remove(c),r.set(h,p)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&o(h)}else o(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function Jo(n,e,t){let A;function i(d){A=d}let r,s;function a(d){r=d.type,s=d.bytesPerElement}function l(d,f){n.drawElements(A,f,r,d*s),t.update(f,A,1)}function o(d,f,_){_!==0&&(n.drawElementsInstanced(A,f,r,d*s,_),t.update(f,A,_))}function u(d,f,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(A,f,0,r,d,0,_);let p=0;for(let c=0;c<_;c++)p+=f[c];t.update(p,A,1)}function h(d,f,_,v){if(_===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let c=0;c<d.length;c++)o(d[c]/s,f[c],v[c]);else{p.multiDrawElementsInstancedWEBGL(A,f,0,r,d,0,v,0,_);let c=0;for(let w=0;w<_;w++)c+=f[w]*v[w];t.update(c,A,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=o,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function el(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function A(r,s,a){switch(t.calls++,s){case n.TRIANGLES:t.triangles+=a*(r/3);break;case n.LINES:t.lines+=a*(r/2);break;case n.LINE_STRIP:t.lines+=a*(r-1);break;case n.LINE_LOOP:t.lines+=a*r;break;case n.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",s);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:A}}function tl(n,e,t){const A=new WeakMap,i=new it;function r(s,a,l){const o=s.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=A.get(a);if(d===void 0||d.count!==h){let M=function(){C.dispose(),A.delete(a),a.removeEventListener("dispose",M)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,v=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],c=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let y=0;f===!0&&(y=1),_===!0&&(y=2),v===!0&&(y=3);let E=a.attributes.position.count*y,D=1;E>e.maxTextureSize&&(D=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const b=new Float32Array(E*D*4*h),C=new Ri(b,E,D,h);C.type=1015,C.needsUpdate=!0;const N=y*4;for(let x=0;x<h;x++){const P=p[x],z=c[x],V=w[x],X=E*D*4*x;for(let $=0;$<P.count;$++){const W=$*N;f===!0&&(i.fromBufferAttribute(P,$),b[X+W+0]=i.x,b[X+W+1]=i.y,b[X+W+2]=i.z,b[X+W+3]=0),_===!0&&(i.fromBufferAttribute(z,$),b[X+W+4]=i.x,b[X+W+5]=i.y,b[X+W+6]=i.z,b[X+W+7]=0),v===!0&&(i.fromBufferAttribute(V,$),b[X+W+8]=i.x,b[X+W+9]=i.y,b[X+W+10]=i.z,b[X+W+11]=V.itemSize===4?i.w:1)}}d={count:h,texture:C,size:new Xe(E,D)},A.set(a,d),a.addEventListener("dispose",M)}if(s.isInstancedMesh===!0&&s.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",s.morphTexture,t);else{let f=0;for(let v=0;v<o.length;v++)f+=o[v];const _=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(n,"morphTargetBaseInfluence",_),l.getUniforms().setValue(n,"morphTargetInfluences",o)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:r}}function Al(n,e,t,A){let i=new WeakMap;function r(l){const o=A.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==o&&(e.update(h),i.set(h,o)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==o&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),i.set(l,o))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==o&&(d.update(),i.set(d,o))}return h}function s(){i=new WeakMap}function a(l){const o=l.target;o.removeEventListener("dispose",a),t.remove(o.instanceMatrix),o.instanceColor!==null&&t.remove(o.instanceColor)}return{update:r,dispose:s}}const _r=new xt,gr=new rr(1,1),vr=new Ri,xr=new os,Mr=new ji,Sr=[],Er=[],Tr=new Float32Array(16),yr=new Float32Array(9),wr=new Float32Array(4);function IA(n,e,t){const A=n[0];if(A<=0||A>0)return n;const i=e*t;let r=Sr[i];if(r===void 0&&(r=new Float32Array(i),Sr[i]=r),e!==0){A.toArray(r,0);for(let s=1,a=0;s!==e;++s)a+=t,n[s].toArray(r,a)}return r}function lt(n,e){if(n.length!==e.length)return!1;for(let t=0,A=n.length;t<A;t++)if(n[t]!==e[t])return!1;return!0}function ct(n,e){for(let t=0,A=e.length;t<A;t++)n[t]=e[t]}function Pn(n,e){let t=Er[e];t===void 0&&(t=new Int32Array(e),Er[e]=t);for(let A=0;A!==e;++A)t[A]=n.allocateTextureUnit();return t}function nl(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function il(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2fv(this.addr,e),ct(t,e)}}function rl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(lt(t,e))return;n.uniform3fv(this.addr,e),ct(t,e)}}function sl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4fv(this.addr,e),ct(t,e)}}function al(n,e){const t=this.cache,A=e.elements;if(A===void 0){if(lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,A))return;wr.set(A),n.uniformMatrix2fv(this.addr,!1,wr),ct(t,A)}}function ol(n,e){const t=this.cache,A=e.elements;if(A===void 0){if(lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,A))return;yr.set(A),n.uniformMatrix3fv(this.addr,!1,yr),ct(t,A)}}function ll(n,e){const t=this.cache,A=e.elements;if(A===void 0){if(lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,A))return;Tr.set(A),n.uniformMatrix4fv(this.addr,!1,Tr),ct(t,A)}}function cl(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function ul(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2iv(this.addr,e),ct(t,e)}}function hl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;n.uniform3iv(this.addr,e),ct(t,e)}}function dl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4iv(this.addr,e),ct(t,e)}}function fl(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function pl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2uiv(this.addr,e),ct(t,e)}}function ml(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;n.uniform3uiv(this.addr,e),ct(t,e)}}function _l(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4uiv(this.addr,e),ct(t,e)}}function gl(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i);let r;this.type===n.SAMPLER_2D_SHADOW?(gr.compareFunction=515,r=gr):r=_r,t.setTexture2D(e||r,i)}function vl(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i),t.setTexture3D(e||xr,i)}function xl(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i),t.setTextureCube(e||Mr,i)}function Ml(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i),t.setTexture2DArray(e||vr,i)}function Sl(n){switch(n){case 5126:return nl;case 35664:return il;case 35665:return rl;case 35666:return sl;case 35674:return al;case 35675:return ol;case 35676:return ll;case 5124:case 35670:return cl;case 35667:case 35671:return ul;case 35668:case 35672:return hl;case 35669:case 35673:return dl;case 5125:return fl;case 36294:return pl;case 36295:return ml;case 36296:return _l;case 35678:case 36198:case 36298:case 36306:case 35682:return gl;case 35679:case 36299:case 36307:return vl;case 35680:case 36300:case 36308:case 36293:return xl;case 36289:case 36303:case 36311:case 36292:return Ml}}function El(n,e){n.uniform1fv(this.addr,e)}function Tl(n,e){const t=IA(e,this.size,2);n.uniform2fv(this.addr,t)}function yl(n,e){const t=IA(e,this.size,3);n.uniform3fv(this.addr,t)}function wl(n,e){const t=IA(e,this.size,4);n.uniform4fv(this.addr,t)}function bl(n,e){const t=IA(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Rl(n,e){const t=IA(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Pl(n,e){const t=IA(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Dl(n,e){n.uniform1iv(this.addr,e)}function Cl(n,e){n.uniform2iv(this.addr,e)}function Ll(n,e){n.uniform3iv(this.addr,e)}function Il(n,e){n.uniform4iv(this.addr,e)}function Ul(n,e){n.uniform1uiv(this.addr,e)}function Fl(n,e){n.uniform2uiv(this.addr,e)}function Nl(n,e){n.uniform3uiv(this.addr,e)}function Bl(n,e){n.uniform4uiv(this.addr,e)}function Ol(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTexture2D(e[s]||_r,r[s])}function zl(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTexture3D(e[s]||xr,r[s])}function Hl(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTextureCube(e[s]||Mr,r[s])}function Gl(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTexture2DArray(e[s]||vr,r[s])}function Vl(n){switch(n){case 5126:return El;case 35664:return Tl;case 35665:return yl;case 35666:return wl;case 35674:return bl;case 35675:return Rl;case 35676:return Pl;case 5124:case 35670:return Dl;case 35667:case 35671:return Cl;case 35668:case 35672:return Ll;case 35669:case 35673:return Il;case 5125:return Ul;case 36294:return Fl;case 36295:return Nl;case 36296:return Bl;case 35678:case 36198:case 36298:case 36306:case 35682:return Ol;case 35679:case 36299:case 36307:return zl;case 35680:case 36300:case 36308:case 36293:return Hl;case 36289:case 36303:case 36311:case 36292:return Gl}}class kl{constructor(e,t,A){this.id=e,this.addr=A,this.cache=[],this.type=t.type,this.setValue=Sl(t.type)}}class Wl{constructor(e,t,A){this.id=e,this.addr=A,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Vl(t.type)}}class Xl{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,A){const i=this.seq;for(let r=0,s=i.length;r!==s;++r){const a=i[r];a.setValue(e,t[a.id],A)}}}const mi=/(\w+)(\])?(\[|\.)?/g;function br(n,e){n.seq.push(e),n.map[e.id]=e}function ql(n,e,t){const A=n.name,i=A.length;for(mi.lastIndex=0;;){const r=mi.exec(A),s=mi.lastIndex;let a=r[1];const l=r[2]==="]",o=r[3];if(l&&(a=a|0),o===void 0||o==="["&&s+2===i){br(t,o===void 0?new kl(a,n,e):new Wl(a,n,e));break}else{let h=t.map[a];h===void 0&&(h=new Xl(a),br(t,h)),t=h}}}class Dn{constructor(e,t){this.seq=[],this.map={};const A=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<A;++i){const r=e.getActiveUniform(t,i),s=e.getUniformLocation(t,r.name);ql(r,s,this)}}setValue(e,t,A,i){const r=this.map[t];r!==void 0&&r.setValue(e,A,i)}setOptional(e,t,A){const i=t[A];i!==void 0&&this.setValue(e,A,i)}static upload(e,t,A,i){for(let r=0,s=t.length;r!==s;++r){const a=t[r],l=A[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const A=[];for(let i=0,r=e.length;i!==r;++i){const s=e[i];s.id in t&&A.push(s)}return A}}function Rr(n,e,t){const A=n.createShader(e);return n.shaderSource(A,t),n.compileShader(A),A}const Yl=37297;let $l=0;function jl(n,e){const t=n.split(`
`),A=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let s=i;s<r;s++){const a=s+1;A.push(`${a===e?">":" "} ${a}: ${t[s]}`)}return A.join(`
`)}const Pr=new Le;function Kl(n){Ge._getMatrix(Pr,Ge.workingColorSpace,n);const e=`mat3( ${Pr.elements.map(t=>t.toFixed(4))} )`;switch(Ge.getTransfer(n)){case en:return[e,"LinearTransferOETF"];case qe:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Dr(n,e,t){const A=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(A&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+jl(n.getShaderSource(e),a)}else return r}function Zl(n,e){const t=Kl(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Ql(n,e){let t;switch(e){case 1:t="Linear";break;case 2:t="Reinhard";break;case 3:t="Cineon";break;case 4:t="ACESFilmic";break;case 6:t="AgX";break;case 7:t="Neutral";break;case 5:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Cn=new U;function Jl(){Ge.getLuminanceCoefficients(Cn);const n=Cn.x.toFixed(4),e=Cn.y.toFixed(4),t=Cn.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ec(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(KA).join(`
`)}function tc(n){const e=[];for(const t in n){const A=n[t];A!==!1&&e.push("#define "+t+" "+A)}return e.join(`
`)}function Ac(n,e){const t={},A=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let i=0;i<A;i++){const r=n.getActiveAttrib(e,i),s=r.name;let a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),t[s]={type:r.type,location:n.getAttribLocation(e,s),locationSize:a}}return t}function KA(n){return n!==""}function Cr(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Lr(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const nc=/^[ \t]*#include +<([\w\d./]+)>/gm;function _i(n){return n.replace(nc,rc)}const ic=new Map;function rc(n,e){let t=Ue[e];if(t===void 0){const A=ic.get(e);if(A!==void 0)t=Ue[A],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,A);else throw new Error("Can not resolve #include <"+e+">")}return _i(t)}const sc=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ir(n){return n.replace(sc,ac)}function ac(n,e,t,A){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=A.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Ur(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function oc(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===1?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===2?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===3&&(e="SHADOWMAP_TYPE_VSM"),e}function lc(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case 301:case 302:e="ENVMAP_TYPE_CUBE";break;case 306:e="ENVMAP_TYPE_CUBE_UV";break}return e}function cc(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case 302:e="ENVMAP_MODE_REFRACTION";break}return e}function uc(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case 0:e="ENVMAP_BLENDING_MULTIPLY";break;case 1:e="ENVMAP_BLENDING_MIX";break;case 2:e="ENVMAP_BLENDING_ADD";break}return e}function hc(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,A=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:A,maxMip:t}}function dc(n,e,t,A){const i=n.getContext(),r=t.defines;let s=t.vertexShader,a=t.fragmentShader;const l=oc(t),o=lc(t),u=cc(t),h=uc(t),d=hc(t),f=ec(t),_=tc(r),v=i.createProgram();let p,c,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+c);const y=w+p+s,E=w+c+a,D=Rr(i,i.VERTEX_SHADER,y),b=Rr(i,i.FRAGMENT_SHADER,E);i.attachShader(v,D),i.attachShader(v,b),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function C(P){if(n.debug.checkShaderErrors){const z=i.getProgramInfoLog(v)||"",V=i.getShaderInfoLog(D)||"",X=i.getShaderInfoLog(b)||"",$=z.trim(),W=V.trim(),te=X.trim();let H=!0,re=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(H=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(i,v,D,b);else{const le=Dr(i,D,"vertex"),Se=Dr(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `}),p=new Us(_,v);return p.frustumCulled=!1,p.renderOrder=2,p.userData.stats={count:o,landCount:f},p}function Hr({color:n=1315866,opacity:e=.13,latStep:t=10,lngStep:A=10,latLimit:i=80,segments:r=128}={}){const s=[],a=new U,l=(d,f)=>{UA(d,f,1.0005,a),s.push(a.x,a.y,a.z)};for(let d=-i;d<=i;d+=t)for(let f=0;f<r;f++)l(d,-180+f/r*360),l(d,-180+(f+1)/r*360);for(let d=-180;d<180;d+=A)for(let f=0;f<r;f++)l(-90+f/r*180,d),l(-90+(f+1)/r*180,d);const o=new Tt;o.setAttribute("position",new ot(new Float32Array(s),3));const u=new Nt({transparent:!0,depthWrite:!1,uniforms:{uColor:{value:new ze(n)},uOpacity:{value:e},uCamDir:{value:new U(0,0,1)},uFadeStart:{value:.1}},vertexShader:`
      uniform vec3 uCamDir;
      varying float vFacing;
      void main() {
        vFacing = dot(normalize(position), uCamDir);
    ...
    `}),h=new Cs(o,u);return h.frustumCulled=!1,h.renderOrder=1,h}function $c({color:n=1315866,opacity:e=.28,segments:t=512}={}){const A=new Float32Array(t*3);for(let l=0;l<t;l++){const o=l/t*Math.PI*2;A[l*3]=Math.cos(o),A[l*3+1]=Math.sin(o),A[l*3+2]=0}const i=new Tt;i.setAttribute("position",new ot(A,3));const r=new Zi({color:n,transparent:!0,opacity:e,depthWrite:!1}),s=new Ls(i,r);s.frustumCulled=!1,s.renderOrder=3;const a=new U(0,0,1);return s.userData.faceCamera=l=>{s.quaternion.setFromUnitVectors(a,l)},s}function jc(n){const e=n.length,t=new Float32Array(e*2*3),A=new Float32Array(e*2*3),i=new Float32Array(e*2*3),r=new Float32Array(e*2),s=new Float32Array(e*2);for(let o=0;o<e;o++){const u=n[o],h=n[Math.max(o-1,0)],d=n[Math.min(o+1,e-1)],f=e===1?0:o/(e-1);for(let _=0;_<2;_++){const v=(o*2+_)*3;t[v]=u.x,t[v+1]=u.y,t[v+2]=u.z,A[v]=h.x,A[v+1]=h.y,A[v+2]=h.z,i[v]=d.x,i[v+1]=d.y,i[v+2]=d.z,r[o*2+_]=_===0?-1:1,s[o*2+_]=f}}const a=new Uint32Array((e-1)*6);for(let o=0;o<e-1;o++){const u=o*2,h=o*6;a[h]=u,a[h+1]=u+1,a[h+2]=u+2,a[h+3]=u+2,a[h+4]=u+1,a[h+5]=u+3}const l=new Tt;return l.setAttribute("position",new ot(t,3)),l.setAttribute("aPrev",new ot(A,3)),l.setAttribute("aNext",new ot(i,3)),l.setAttribute("aSide",new ot(r,1)),l.setAttribute("aAlong",new ot(s,1)),l.setIndex(new ot(a,1)),l}const Kc=`
...
`;function Gr({baseColor:n=6710886,satColor:e=0,baseOpacity:t=.18,satOpacity:A=1,width:i=2,opacity:r=1,mode:s=0,tailLength:a=.035,satFeather:l=.02}={}){return new Nt({transparent:!0,depthWrite:!1,depthTest:!1,side:2,uniforms:{uResolution:{value:new Xe(1,1)},uWidth:{value:i},uOpacity:{value:r},uBaseColor:{value:new ze(n)},uSatColor:{value:new ze(e)},uBaseOpacity:{value:t},uSatOpacity:{value:A},uDrawProgress:{value:0},uHeadT:{value:0},uTailLength:{value:a},uSatFeather:{value:l},uMode:{value:s},uCamDir:{value:new U(0,0,1)}},vertexShader:Kc,fragmentShader:Zc})}function Qc(n,e,t,A=new U){const i=Math.min(1,Math.max(-1,n.dot(e))),r=Math.acos(i);if(r<1e-6)return A.copy(n);const s=Math.sin(r),a=Math.sin((1-t)*r)/s,l=Math.sin(t*r)/s;return A.set(n.x*a+e.x*l,n.y*a+e.y*l,n.z*a+e.z*l)}function Jc(n,e,{segments:t=192,lift:A=.055}={}){const i=UA(n.lat,n.lng,1),r=UA(e.lat,e.lng,1),s=[];for(let a=0;a<=t;a++){const l=a/t,o=Qc(i,r,l);o.multiplyScalar(1+A*Math.sin(Math.PI*l)),s.push(o)}return s}class eu{constructor(e,t,{segments:A=192,lift:i=.055,width:r=2,dropWidth:s=7,baseColor:a=6710886,satColor:l=0,baseOpacity:o=.18,satOpacity:u=1,dropBaseColor:h=4473924,tailLength:d=.035}={}){this.from=e,this.to=t,this.tailLength=d;const f=Jc(e,t,{segments:A,lift:i});this.geometry=jc(f),this.arcMaterial=Gr({baseColor:a,satColor:l,baseOpacity:o,satOpacity:u,width:r,mode:0,tailLength:d}),this.dropMaterial=Gr({baseColor:h,satColor:l,baseOpacity:.75,satOpacity:1,width:s,mode:1,tailLength:d}),this.arc=new Ft(this.geometry,this.arcMaterial),this.drop=new Ft(this.geometry,this.dropMaterial),this.arc.frustumCulled=!1,this.drop.frustumCulled=!1,this.arc.renderOrder=10,this.drop.renderOrder=11,this.group=new $A,this.group.add(this.arc,this.drop),this.setProgress(0),this.setHead(0)}setProgress(e){const t=Math.min(1,Math.max(0,e));return this.arcMaterial.uniforms.uDrawProgress.value=t,this.dropMaterial.uniforms.uDrawProgress.value=t,this}setHead(e){const t=Math.min(1,Math.max(0,e));return this.arcMaterial.uniforms.uHeadT.value=t,this.dropMaterial.uniforms.uHeadT.value=t,this}setOpacity(e){return this.arcMaterial.uniforms.uOpacity.value=e,this.dropMaterial.uniforms.uOpacity.value=e,this}syncCamera(e,t,A){for(const i of[this.arcMaterial,this.dropMaterial])i.uniforms.uCamDir.value.copy(e),i.uniforms.uResolution.value.set(t,A);return this}dispose(){this.geometry.dispose(),this.arcMaterial.dispose(),this.dropMaterial.dispose()}}const tu=2,Au=500,nu=[.7,1.6];class iu{constructor(e,t){this.root=e,e.style.pointerEvents||(e.style.pointerEvents="none"),this.layout=t,this.anchor=document.querySelector("[data-globe-anchor]")||e,this.canvas=document.createElement("canvas"),this.canvas.className="globe-canvas",Object.assign(this.canvas.style,{position:"absolute",inset:"0",width:"100%",height:"100%",display:"block",pointerEvents:"none"}),e.appendChild(this.canvas),this.renderer=new Gc({canvas:this.canvas,alpha:!0,antialias:!0,powerPreference:"high-performance"}),this.renderer.setClearColor(0,0),this.scene=new bs,this.globeCam=new Vc,this.globeCam.lookAtLatLng(t.cameraLat,t.cameraLng),this.gridOpts={},this.dotOpts={},this.rimOpts={},this.grid=Hr(this.gridOpts),this.dots=zr(this.dotOpts),this.rim=$c(this.rimOpts),this.scene.add(this.grid,this.dots,this.rim),this.routes=[],this._needsResize=!0,this._size={w:0,h:0,dpr:0},this._onFrame=[],this._ro=new ResizeObserver(()=>{this._needsResize=!0}),this._ro.observe(this.root),this._onWindowResize=()=>{this._needsResize=!0},window.addEventListener("resize",this._onWindowResize),window.addEventListener("scroll",this._onWindowResize,{passive:!0}),this._raf=null,this._lastTime=0,this.deltaSeconds=0}onFrame(e){return this._onFrame.push(e),()=>{const t=this._onFrame.indexOf(e);t>=0&&this._onFrame.splice(t,1)}}project(e,t,A=0){return this.globeCam.project(e,t,A)}_applyLayout(){const e=this.root.getBoundingClientRect(),t=this.anchor.getBoundingClientRect(),A=Math.max(1,Math.round(e.width)),i=Math.max(1,Math.round(e.height)),r=Math.min(window.devicePixelRatio||1,tu);(A!==this._size.w||i!==this._size.h||r!==this._size.dpr)&&(this.renderer.setPixelRatio(r),this.renderer.setSize(A,i,!1),this._size={w:A,h:i,dpr:r},this.dots.material.uniforms.uPixelRatio.value=r);const s=t.width*this.layout.radiusScale,a={x:t.left-e.left+t.width/2,y:t.top-e.top+s*this.layout.centerYFactor};this.globeCam.layout(A,i,a,s);const[l,o]=nu;this.dots.material.uniforms.uSizeScale.value=Math.min(o,Math.max(l,s/Au)),this._syncCamDir(),this._needsResize=!1}_syncCamDir(){const e=this.globeCam.camDir;this.dots.material.uniforms.uCamDir.value.copy(e),this.grid.material.uniforms.uCamDir.value.copy(e),this.rim.userData.faceCamera(e);for(const t of this.routes)t.syncCamera(e,this._size.w||1,this._size.h||1)}addRoute(e,t,A){const i=new eu(e,t,A);return this.routes.push(i),this.scene.add(i.group),this._needsResize=!0,i}_replace(e,t,A){const i=this[e];return this.scene.remove(i),i.geometry.dispose(),i.material.dispose(),this[e]=t(A),this.scene.add(this[e]),this._syncCamDir(),e==="dots"&&(this.dots.material.uniforms.uPixelRatio.value=this._size.dpr||1,this._needsResize=!0),this[e]}setGrid(e){return Object.assign(this.gridOpts,e),this._replace("grid",Hr,this.gridOpts)}setDots(e){return Object.assign(this.dotOpts,e),this._replace("dots",zr,this.dotOpts)}start(){if(this._raf!==null)return;const e=t=>{this._raf=requestAnimationFrame(e),this.deltaSeconds=this._lastTime?Math.min((t-this._lastTime)/1e3,.1):0,this._lastTime=t,this._needsResize&&this._applyLayout();for(const A of this._onFrame)A(t,this);this.renderer.render(this.scene,this.globeCam.camera)};this._raf=requestAnimationFrame(e)}stop(){this._raf!==null&&cancelAnimationFrame(this._raf),this._raf=null,this._lastTime=0,this.deltaSeconds=0}dispose(){this.stop(),this._ro.disconnect(),window.removeEventListener("resize",this._onWindowResize),window.removeEventListener("scroll",this._onWindowResize),this.renderer.dispose(),this.canvas.remove()}}const Vr=[{id:"origin",lat:37.7749,lng:-122.4194,label:"San Francisco"},{id:"destination",lat:40.7128,lng:-74.006,label:"New York"}],QA={radiusScale:.403,centerYFactor:.925,cameraLat:-4,cameraLng:-91};function FA(n,e,t){const A=n.getAttribute(e);if(A===null||A.trim()==="")return t;const i=Number.parseFloat(A);return Number.isFinite(i)?i:t}function ru(n=document){const e=n.querySelectorAll("[data-globe-place]");if(!e.length)return Vr;const t=[];return e.forEach((A,i)=>{const r=FA(A,"data-lat",NaN),s=FA(A,"data-lng",NaN);if(!Number.isFinite(r)||!Number.isFinite(s)){console.warn("[globe] skipping place with bad lat/lng",A);return}t.push({id:A.getAttribute("data-id")||`place-${i}`,lat:r,lng:s,label:A.getAttribute("data-label")||"",el:A})}),t.length?t:Vr}function su(n){return n?{radiusScale:FA(n,"data-radius-scale",QA.radiusScale),centerYFactor:FA(n,"data-center-y",QA.centerYFactor),cameraLat:FA(n,"data-camera-lat",QA.cameraLat),cameraLng:FA(n,"data-camera-lng",QA.cameraLng)}:{...QA}}const au=[["San Francisco",37.7749,-122.4194],["New York",40.7128,-74.006],["London",51.5074,-.1278],["Reykjavik",64.1466,-21.9426],["Mexico City",19.4326,-99.1332],["Bogota",4.711,-74.0721],["Anchorage",61.2181,-149.9003],["Lagos",6.5244,3.3792],["Tokyo",35.6762,139.6503],["Sydney",-33.8688,151.2093],["Cape Town",-33.9249,18.4241],["Honolulu",21.3069,-157.8583],["Null Island",0,0],["North Pole",89.9,0]];function ou(n){const e=document.createElement("div");Object.assign(e.style,{position:"absolute",inset:"0",pointerEvents:"none",zIndex:"40",font:"11px ui-monospace, monospace"}),n.root.appendChild(e);const t=au.map(([A,i,r])=>{const s=document.createElement("div");return s.textContent=A,Object.assign(s.style,{position:"absolute",transform:"translate(-50%, -50%)",padding:"2px 5px",borderRadius:"3px",background:"#ff2d55",color:"#fff",whiteSpace:"nowrap",willChange:"transform, opacity"}),e.appendChild(s),{el:s,lat:i,lng:r}});return n.onFrame(()=>{for(const A of t){const i=n.project(A.lat,A.lng);A.el.style.opacity=i.visible?String(.35+.65*i.depth):"0",A.el.style.transform=`translate(${i.x}px, ${i.y}px) translate(-50%, -50%)`}}),e}const lu=`
...
`;let kr=!1;function cu(n){if(kr)return;kr=!0;const e=n.createElement("style");e.textContent=lu,n.head.appendChild(e)}function uu(n){cu(document);const e=document.createElement("div");return e.className="globe-pin-layer",Object.assign(e.style,{position:"absolute",inset:"0",pointerEvents:"none",zIndex:"40",overflow:"hidden"}),n.root.appendChild(e),e}class Wr{constructor(e,t){this.place=t,this.el=document.createElement("div"),this.el.className="globe-pin";const A=document.createElement("div");A.className="globe-pin__pill",A.textContent=t.label;const i=document.createElement("div");i.className="globe-pin__stem";const r=document.createElement("div");r.className="globe-pin__dot",this.el.append(A,i,r),this.pill=A,this.stem=i,this.dot=r,e.appendChild(this.el),this._amount=0,this.setAmount(0)}setAmount(e){return this._amount=Math.min(1,Math.max(0,e)),this}update(e){const t=e.project(this.place.lat,this.place.lng),A=this._amount;if(!t.visible||A<=.001){this.el.style.opacity="0";return}const i=Math.min(1,t.depth/.12);this.el.style.opacity=String(A*i),this.el.style.transform=`translate(${t.x}px, ${t.y}px)`;const r=1-A;this.pill.style.transform=`translateX(-50%) translateY(${r*10}px)`,this.pill.style.opacity=String(Math.min(1,A*1.4)),this.stem.style.transform=`scaleY(${A})`,this.dot.style.transform=`scale(${.4+.6*A})`}dispose(){this.el.remove()}}const hu=.6;function tA(n,e,t){const A=n.getAttribute(e);if(A===null||A.trim()==="")return t;const i=Number.parseFloat(A);return Number.isFinite(i)?i:t}const vi=n=>n<0?0:n>1?1:n,du=n=>1-Math.pow(1-n,3),fu=n=>1+(1.70158+1)*Math.pow(n-1,3)+1.70158*Math.pow(n-1,2);function pu(n){const e=n.hasAttribute("data-globe-pin"),t=(n.getAttribute("data-anim")||"fade").toLowerCase(),A={el:n,anchored:e,anim:t,lat:tA(n,"data-lat",0),lng:tA(n,"data-lng",0),offsetX:tA(n,"data-offset-x",0),offsetY:tA(n,"data-offset-y",0),inAt:tA(n,"data-in",0),outAt:n.hasAttribute("data-out")?tA(n,"data-out",1/0):null,dur:tA(n,"data-dur",hu),typeSpeed:tA(n,"data-type-speed",26),fullText:null,typedCount:-1};if(t==="type"){A.fullText=n.textContent.replace(/\s+/g," ").trim();const i=n.getBoundingClientRect();i.height&&(n.style.minHeight=`${Math.ceil(i.height)}px`),n.textContent=""}return n.style.willChange="transform, opacity",e&&(n.style.position="absolute",n.style.top="0",n.style.left="0"),A}class mu{constructor(e,t=document){const A=t.querySelectorAll("[data-globe-cue], [data-globe-pin]");this.items=Array.from(A).map(pu),this.stage=e}get maxTime(){return this.items.reduce((e,t)=>{const A=t.outAt!==null?t.outAt+t.dur:t.inAt+t.dur,i=t.fullText?t.inAt+t.fullText.length/t.typeSpeed:0;return Math.max(e,A,i)},0)}update(e,t){for(const A of this.items)this._updateItem(A,e,t)}_updateItem(e,t,A){const i=vi((t-e.inAt)/e.dur),r=e.outAt===null?0:vi((t-e.outAt)/e.dur),s=i*(1-r),a=e.el;if(e.anim==="type"&&this._type(e,t),s<=.001){a.style.opacity="0",a.style.pointerEvents="none";return}let l=s,o=e.offsetX,u=e.offsetY,h=1;if(e.anim==="rise"?u+=(1-du(i))*16:e.anim==="pop"?(h=.86+.14*fu(i),l=vi(i*1.6)*(1-r)):e.anim==="type"&&(l=i>0?1-r:0),e.anchored){const d=A.project(e.lat,e.lng);if(!d.visible){a.style.opacity="0";return}const f=Math.min(1,d.depth/.12);l*=f,a.style.transform=`translate(${d.x+o}px, ${d.y+u}px) translate(-50%, -100%) scale(${h})`}else a.style.transform=`translate(${o}px, ${u}px) scale(${h})`;a.style.opacity=String(l),a.style.pointerEvents=l>.9?"":"none"}_type(e,t){if(e.fullText===null)return;const A=t-e.inAt,i=A<=0?0:Math.min(e.fullText.length,Math.floor(A*e.typeSpeed));i!==e.typedCount&&(e.typedCount=i,e.el.textContent=e.fullText.slice(0,i),e.el.dataset.typing=i<e.fullText.length?"1":"0")}}const Xr={linear:n=>n,outCubic:n=>1-Math.pow(1-n,3),inOutCubic:n=>n<.5?4*n*n*n:1-Math.pow(-2*n+2,3)/2,outBack:n=>1+(1.70158+1)*Math.pow(n-1,3)+1.70158*Math.pow(n-1,2)},_u=[{track:"originPin",at:.15,dur:.75,from:0,to:1,ease:"outBack"},{track:"arcDraw",at:.65,dur:1.5,from:0,to:1,ease:"inOutCubic"},{track:"dropHead",at:1.55,dur:1.9,from:0,to:1,ease:"inOutCubic"},{track:"destPin",at:3.15,dur:.75,from:0,to:1,ease:"outBack"}];class gu{constructor({route:e,originPin:t,destPin:A,beats:i=_u,loop:r=!1,loopDelay:s=2.5}){this.route=e,this.originPin=t,this.destPin=A,this.beats=i,this.loop=r,this.loopDelay=s,this.time=0,this.playing=!1,this.duration=i.reduce((a,l)=>Math.max(a,l.at+l.dur),0),this.values={originPin:0,arcDraw:0,dropHead:0,destPin:0},this._apply()}play(){return this.playing=!0,this}pause(){return this.playing=!1,this}restart(){return this.time=0,this.playing=!0,this}seek(e){return this.time=e,this._sample(),this._apply(),this}complete(){return this.seek(this.duration)}advance(e){if(!this.playing)return this;this.time+=e;const t=this.duration+(this.loop?this.loopDelay:0);return this.time>t&&(this.loop?this.time=0:this.time=this.duration),this._sample(),this._apply(),this}_sample(){for(const e of this.beats){const t=(this.time-e.at)/e.dur,A=Math.min(1,Math.max(0,t)),i=Xr[e.ease]||Xr.linear;this.values[e.track]=e.from+(e.to-e.from)*i(A)}}_apply(){const e=this.values;this.route.setProgress(e.arcDraw),this.route.setHead(e.dropHead),this.originPin&&this.originPin.setAmount(e.originPin),this.destPin&&this.destPin.setAmount(e.destPin)}}function vu(){return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const qr="#globe-root";function Yr(){const n=document.querySelector(qr);if(!n){console.warn(`[globe] no ${qr} on the page`);return}if(n.dataset.globeMounted)return;n.dataset.globeMounted="1";const e=su(n),t=ru(n),A=new iu(n,e),i=t[0],r=t[1];let s=null;if(i&&r){const l=A.addRoute(i,r),o=uu(A),u=new Wr(o,i),h=new Wr(o,r);s=new gu({route:l,originPin:u,destPin:h,loop:n.hasAttribute("data-globe-loop")});const d=new mu(A,document);d.maxTime>s.duration&&(s.duration=d.maxTime),A.onFrame((f,_)=>{s.advance(_.deltaSeconds),u.update(_),h.update(_),d.update(s.time,_)}),window.__globeOverlays=d,vu()?s.complete():s.play()}A.start(),(new URLSearchParams(location.search).has("debug")||n.hasAttribute("data-globe-debug"))&&ou(A),window.__globe={stage:A,layout:e,places:t,flow:s}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Yr,{once:!0}):Yr()})();
