...
#endif`;const Ue={alphahash_fragment:Vs,alphahash_pars_fragment:ks,alphamap_fragment:Ws,alphamap_pars_fragment:Xs,alphatest_fragment:qs,alphatest_pars_fragment:Ys,aomap_fragment:$s,aomap_pars_fragment:js,batching_pars_vertex:Ks,batching_vertex:Zs,begin_vertex:Qs,beginnormal_vertex:Js,bsdfs:ea,iridescence_fragment:ta,bumpmap_pars_fragment:Aa,clipping_planes_fragment:na,clipping_planes_pars_fragment:ia,clipping_planes_pars_vertex:ra,clipping_planes_vertex:sa,color_fragment:aa,color_pars_fragment:oa,color_pars_vertex:la,color_vertex:ca,common:ua,cube_uv_reflection_fragment:ha,defaultnormal_vertex:da,displacementmap_pars_vertex:fa,displacementmap_vertex:pa,emissivemap_fragment:ma,emissivemap_pars_fragment:_a,colorspace_fragment:ga,colorspace_pars_fragment:va,envmap_fragment:xa,envmap_common_pars_fragment:Ma,envmap_pars_fragment:Sa,envmap_pars_vertex:Ea,envmap_physical_pars_fragment:Ua,envmap_vertex:ya,fog_vertex:Ta,fog_pars_vertex:wa,fog_fragment:ba,fog_pars_fragment:Ra,gradientmap_pars_fragment:Pa,lightmap_pars_fragment:Da,lights_lambert_fragment:Ca,lights_lambert_pars_fragment:La,lights_pars_begin:Ia,lights_toon_fragment:Fa,lights_toon_pars_fragment:Na,lights_phong_fragment:Ba,lights_phong_pars_fragment:Oa,lights_physical_fragment:za,lights_physical_pars_fragment:Ha,lights_fragment_begin:Ga,lights_fragment_maps:Va,lights_fragment_end:ka,logdepthbuf_fragment:Wa,logdepthbuf_pars_fragment:Xa,logdepthbuf_pars_vertex:qa,logdepthbuf_vertex:Ya,map_fragment:$a,map_pars_fragment:ja,map_particle_fragment:Ka,map_particle_pars_fragment:Za,metalnessmap_fragment:Qa,metalnessmap_pars_fragment:Ja,morphinstance_vertex:eo,morphcolor_vertex:to,morphnormal_vertex:Ao,morphtarget_pars_vertex:no,morphtarget_vertex:io,normal_fragment_begin:ro,normal_fragment_maps:so,normal_pars_fragment:ao,normal_pars_vertex:oo,normal_vertex:lo,normalmap_pars_fragment:co,clearcoat_normal_fragment_begin:uo,clearcoat_normal_fragment_maps:ho,clearcoat_pars_fragment:fo,iridescence_pars_fragment:po,opaque_fragment:mo,packing:_o,premultiplied_alpha_fragment:go,project_vertex:vo,dithering_fragment:xo,dithering_pars_fragment:Mo,roughnessmap_fragment:So,roughnessmap_pars_fragment:Eo,shadowmap_pars_fragment:yo,shadowmap_pars_vertex:To,shadowmap_vertex:wo,shadowmask_pars_fragment:bo,skinbase_vertex:Ro,skinning_pars_vertex:Po,skinning_vertex:Do,skinnormal_vertex:Co,specularmap_fragment:Lo,specularmap_pars_fragment:Io,tonemapping_fragment:Uo,tonemapping_pars_fragment:Fo,transmission_fragment:No,transmission_pars_fragment:Bo,uv_pars_fragment:Oo,uv_pars_vertex:zo,uv_vertex:Ho,worldpos_vertex:Go,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	`}function Qo(n){let e=new WeakMap,t=null;function A(a){if(a&&a.isTexture){const l=a.mapping,o=l===303||l===304,u=l===301||l===302;if(o||u){let h=e.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new dr(n)),h=o?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return o&&f&&f.height>0||u&&f&&i(f)?(t===null&&(t=new dr(n)),h=o?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function i(a){let l=0;const o=6;for(let u=0;u<o;u++)a[u]!==void 0&&l++;return l===o}function r(a){const l=a.target;l.removeEventListener("dispose",r);const o=e.get(l);o!==void 0&&(e.delete(l),o.dispose())}function s(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:A,dispose:s}}function Jo(n){const e={};function t(A){if(e[A]!==void 0)return e[A];let i;switch(A){case"WEBGL_depth_texture":i=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=n.getExtension(A)}return e[A]=i,i}return{has:function(A){return t(A)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(A){const i=t(A);return i===null&&GA("THREE.WebGLRenderer: "+A+" extension not supported."),i}}}function el(n,e,t,A){const i={},r=new WeakMap;function s(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);d.removeEventListener("dispose",s),delete i[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),A.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return i[d.id]===!0||(d.addEventListener("dispose",s),i[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const f in d)e.update(d[f],n.ARRAY_BUFFER)}function o(h){const d=[],f=h.index,_=h.attributes.position;let v=0;if(f!==null){const w=f.array;v=f.version;for(let T=0,E=w.length;T<E;T+=3){const D=w[T+0],b=w[T+1],C=w[T+2];d.push(D,b,b,C,C,D)}}else if(_!==void 0){const w=_.array;v=_.version;for(let T=0,E=w.length/3-1;T<E;T+=3){const D=T+0,b=T+1,C=T+2;d.push(D,b,b,C,C,D)}}else return;const p=new(yi(d)?Gi:Hi)(d,1);p.version=v;const c=r.get(h);c&&e.remove(c),r.set(h,p)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&o(h)}else o(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function tl(n,e,t){let A;function i(d){A=d}let r,s;function a(d){r=d.type,s=d.bytesPerElement}function l(d,f){n.drawElements(A,f,r,d*s),t.update(f,A,1)}function o(d,f,_){_!==0&&(n.drawElementsInstanced(A,f,r,d*s,_),t.update(f,A,_))}function u(d,f,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(A,f,0,r,d,0,_);let p=0;for(let c=0;c<_;c++)p+=f[c];t.update(p,A,1)}function h(d,f,_,v){if(_===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let c=0;c<d.length;c++)o(d[c]/s,f[c],v[c]);else{p.multiDrawElementsInstancedWEBGL(A,f,0,r,d,0,v,0,_);let c=0;for(let w=0;w<_;w++)c+=f[w]*v[w];t.update(c,A,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=o,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Al(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function A(r,s,a){switch(t.calls++,s){case n.TRIANGLES:t.triangles+=a*(r/3);break;case n.LINES:t.lines+=a*(r/2);break;case n.LINE_STRIP:t.lines+=a*(r-1);break;case n.LINE_LOOP:t.lines+=a*r;break;case n.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",s);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:A}}function nl(n,e,t){const A=new WeakMap,i=new it;function r(s,a,l){const o=s.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=A.get(a);if(d===void 0||d.count!==h){let M=function(){C.dispose(),A.delete(a),a.removeEventListener("dispose",M)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,v=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],c=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let T=0;f===!0&&(T=1),_===!0&&(T=2),v===!0&&(T=3);let E=a.attributes.position.count*T,D=1;E>e.maxTextureSize&&(D=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const b=new Float32Array(E*D*4*h),C=new Ri(b,E,D,h);C.type=1015,C.needsUpdate=!0;const N=T*4;for(let x=0;x<h;x++){const P=p[x],z=c[x],V=w[x],X=E*D*4*x;for(let $=0;$<P.count;$++){const W=$*N;f===!0&&(i.fromBufferAttribute(P,$),b[X+W+0]=i.x,b[X+W+1]=i.y,b[X+W+2]=i.z,b[X+W+3]=0),_===!0&&(i.fromBufferAttribute(z,$),b[X+W+4]=i.x,b[X+W+5]=i.y,b[X+W+6]=i.z,b[X+W+7]=0),v===!0&&(i.fromBufferAttribute(V,$),b[X+W+8]=i.x,b[X+W+9]=i.y,b[X+W+10]=i.z,b[X+W+11]=V.itemSize===4?i.w:1)}}d={count:h,texture:C,size:new Xe(E,D)},A.set(a,d),a.addEventListener("dispose",M)}if(s.isInstancedMesh===!0&&s.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",s.morphTexture,t);else{let f=0;for(let v=0;v<o.length;v++)f+=o[v];const _=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(n,"morphTargetBaseInfluence",_),l.getUniforms().setValue(n,"morphTargetInfluences",o)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:r}}function il(n,e,t,A){let i=new WeakMap;function r(l){const o=A.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==o&&(e.update(h),i.set(h,o)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==o&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),i.set(l,o))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==o&&(d.update(),i.set(d,o))}return h}function s(){i=new WeakMap}function a(l){const o=l.target;o.removeEventListener("dispose",a),t.remove(o.instanceMatrix),o.instanceColor!==null&&t.remove(o.instanceColor)}return{update:r,dispose:s}}const _r=new xt,gr=new rr(1,1),vr=new Ri,xr=new cs,Mr=new ji,Sr=[],Er=[],yr=new Float32Array(16),Tr=new Float32Array(9),wr=new Float32Array(4);function FA(n,e,t){const A=n[0];if(A<=0||A>0)return n;const i=e*t;let r=Sr[i];if(r===void 0&&(r=new Float32Array(i),Sr[i]=r),e!==0){A.toArray(r,0);for(let s=1,a=0;s!==e;++s)a+=t,n[s].toArray(r,a)}return r}function lt(n,e){if(n.length!==e.length)return!1;for(let t=0,A=n.length;t<A;t++)if(n[t]!==e[t])return!1;return!0}function ct(n,e){for(let t=0,A=e.length;t<A;t++)n[t]=e[t]}function Pn(n,e){let t=Er[e];t===void 0&&(t=new Int32Array(e),Er[e]=t);for(let A=0;A!==e;++A)t[A]=n.allocateTextureUnit();return t}function rl(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function sl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2fv(this.addr,e),ct(t,e)}}function al(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(lt(t,e))return;n.uniform3fv(this.addr,e),ct(t,e)}}function ol(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4fv(this.addr,e),ct(t,e)}}function ll(n,e){const t=this.cache,A=e.elements;if(A===void 0){if(lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,A))return;wr.set(A),n.uniformMatrix2fv(this.addr,!1,wr),ct(t,A)}}function cl(n,e){const t=this.cache,A=e.elements;if(A===void 0){if(lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,A))return;Tr.set(A),n.uniformMatrix3fv(this.addr,!1,Tr),ct(t,A)}}function ul(n,e){const t=this.cache,A=e.elements;if(A===void 0){if(lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,A))return;yr.set(A),n.uniformMatrix4fv(this.addr,!1,yr),ct(t,A)}}function hl(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function dl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2iv(this.addr,e),ct(t,e)}}function fl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;n.uniform3iv(this.addr,e),ct(t,e)}}function pl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4iv(this.addr,e),ct(t,e)}}function ml(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function _l(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2uiv(this.addr,e),ct(t,e)}}function gl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;n.uniform3uiv(this.addr,e),ct(t,e)}}function vl(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4uiv(this.addr,e),ct(t,e)}}function xl(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i);let r;this.type===n.SAMPLER_2D_SHADOW?(gr.compareFunction=515,r=gr):r=_r,t.setTexture2D(e||r,i)}function Ml(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i),t.setTexture3D(e||xr,i)}function Sl(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i),t.setTextureCube(e||Mr,i)}function El(n,e,t){const A=this.cache,i=t.allocateTextureUnit();A[0]!==i&&(n.uniform1i(this.addr,i),A[0]=i),t.setTexture2DArray(e||vr,i)}function yl(n){switch(n){case 5126:return rl;case 35664:return sl;case 35665:return al;case 35666:return ol;case 35674:return ll;case 35675:return cl;case 35676:return ul;case 5124:case 35670:return hl;case 35667:case 35671:return dl;case 35668:case 35672:return fl;case 35669:case 35673:return pl;case 5125:return ml;case 36294:return _l;case 36295:return gl;case 36296:return vl;case 35678:case 36198:case 36298:case 36306:case 35682:return xl;case 35679:case 36299:case 36307:return Ml;case 35680:case 36300:case 36308:case 36293:return Sl;case 36289:case 36303:case 36311:case 36292:return El}}function Tl(n,e){n.uniform1fv(this.addr,e)}function wl(n,e){const t=FA(e,this.size,2);n.uniform2fv(this.addr,t)}function bl(n,e){const t=FA(e,this.size,3);n.uniform3fv(this.addr,t)}function Rl(n,e){const t=FA(e,this.size,4);n.uniform4fv(this.addr,t)}function Pl(n,e){const t=FA(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Dl(n,e){const t=FA(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Cl(n,e){const t=FA(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Ll(n,e){n.uniform1iv(this.addr,e)}function Il(n,e){n.uniform2iv(this.addr,e)}function Ul(n,e){n.uniform3iv(this.addr,e)}function Fl(n,e){n.uniform4iv(this.addr,e)}function Nl(n,e){n.uniform1uiv(this.addr,e)}function Bl(n,e){n.uniform2uiv(this.addr,e)}function Ol(n,e){n.uniform3uiv(this.addr,e)}function zl(n,e){n.uniform4uiv(this.addr,e)}function Hl(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTexture2D(e[s]||_r,r[s])}function Gl(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTexture3D(e[s]||xr,r[s])}function Vl(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTextureCube(e[s]||Mr,r[s])}function kl(n,e,t){const A=this.cache,i=e.length,r=Pn(t,i);lt(A,r)||(n.uniform1iv(this.addr,r),ct(A,r));for(let s=0;s!==i;++s)t.setTexture2DArray(e[s]||vr,r[s])}function Wl(n){switch(n){case 5126:return Tl;case 35664:return wl;case 35665:return bl;case 35666:return Rl;case 35674:return Pl;case 35675:return Dl;case 35676:return Cl;case 5124:case 35670:return Ll;case 35667:case 35671:return Il;case 35668:case 35672:return Ul;case 35669:case 35673:return Fl;case 5125:return Nl;case 36294:return Bl;case 36295:return Ol;case 36296:return zl;case 35678:case 36198:case 36298:case 36306:case 35682:return Hl;case 35679:case 36299:case 36307:return Gl;case 35680:case 36300:case 36308:case 36293:return Vl;case 36289:case 36303:case 36311:case 36292:return kl}}class Xl{constructor(e,t,A){this.id=e,this.addr=A,this.cache=[],this.type=t.type,this.setValue=yl(t.type)}}class ql{constructor(e,t,A){this.id=e,this.addr=A,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Wl(t.type)}}class Yl{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,A){const i=this.seq;for(let r=0,s=i.length;r!==s;++r){const a=i[r];a.setValue(e,t[a.id],A)}}}const mi=/(\w+)(\])?(\[|\.)?/g;function br(n,e){n.seq.push(e),n.map[e.id]=e}function $l(n,e,t){const A=n.name,i=A.length;for(mi.lastIndex=0;;){const r=mi.exec(A),s=mi.lastIndex;let a=r[1];const l=r[2]==="]",o=r[3];if(l&&(a=a|0),o===void 0||o==="["&&s+2===i){br(t,o===void 0?new Xl(a,n,e):new ql(a,n,e));break}else{let h=t.map[a];h===void 0&&(h=new Yl(a),br(t,h)),t=h}}}class Dn{constructor(e,t){this.seq=[],this.map={};const A=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<A;++i){const r=e.getActiveUniform(t,i),s=e.getUniformLocation(t,r.name);$l(r,s,this)}}setValue(e,t,A,i){const r=this.map[t];r!==void 0&&r.setValue(e,A,i)}setOptional(e,t,A){const i=t[A];i!==void 0&&this.setValue(e,A,i)}static upload(e,t,A,i){for(let r=0,s=t.length;r!==s;++r){const a=t[r],l=A[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const A=[];for(let i=0,r=e.length;i!==r;++i){const s=e[i];s.id in t&&A.push(s)}return A}}function Rr(n,e,t){const A=n.createShader(e);return n.shaderSource(A,t),n.compileShader(A),A}const jl=37297;let Kl=0;function Zl(n,e){const t=n.split(`
`),A=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let s=i;s<r;s++){const a=s+1;A.push(`${a===e?">":" "} ${a}: ${t[s]}`)}return A.join(`
`)}const Pr=new Le;function Ql(n){Ge._getMatrix(Pr,Ge.workingColorSpace,n);const e=`mat3( ${Pr.elements.map(t=>t.toFixed(4))} )`;switch(Ge.getTransfer(n)){case en:return[e,"LinearTransferOETF"];case qe:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Dr(n,e,t){const A=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(A&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Zl(n.getShaderSource(e),a)}else return r}function Jl(n,e){const t=Ql(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function ec(n,e){let t;switch(e){case 1:t="Linear";break;case 2:t="Reinhard";break;case 3:t="Cineon";break;case 4:t="ACESFilmic";break;case 6:t="AgX";break;case 7:t="Neutral";break;case 5:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Cn=new U;function tc(){Ge.getLuminanceCoefficients(Cn);const n=Cn.x.toFixed(4),e=Cn.y.toFixed(4),t=Cn.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Ac(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ZA).join(`
`)}function nc(n){const e=[];for(const t in n){const A=n[t];A!==!1&&e.push("#define "+t+" "+A)}return e.join(`
`)}function ic(n,e){const t={},A=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let i=0;i<A;i++){const r=n.getActiveAttrib(e,i),s=r.name;let a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),t[s]={type:r.type,location:n.getAttribLocation(e,s),locationSize:a}}return t}function ZA(n){return n!==""}function Cr(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Lr(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const rc=/^[ \t]*#include +<([\w\d./]+)>/gm;function _i(n){return n.replace(rc,ac)}const sc=new Map;function ac(n,e){let t=Ue[e];if(t===void 0){const A=sc.get(e);if(A!==void 0)t=Ue[A],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,A);else throw new Error("Can not resolve #include <"+e+">")}return _i(t)}const oc=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ir(n){return n.replace(oc,lc)}function lc(n,e,t,A){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=A.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Ur(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function cc(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===1?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===2?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===3&&(e="SHADOWMAP_TYPE_VSM"),e}function uc(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case 301:case 302:e="ENVMAP_TYPE_CUBE";break;case 306:e="ENVMAP_TYPE_CUBE_UV";break}return e}function hc(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case 302:e="ENVMAP_MODE_REFRACTION";break}return e}function dc(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case 0:e="ENVMAP_BLENDING_MULTIPLY";break;case 1:e="ENVMAP_BLENDING_MIX";break;case 2:e="ENVMAP_BLENDING_ADD";break}return e}function fc(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,A=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:A,maxMip:t}}function pc(n,e,t,A){const i=n.getContext(),r=t.defines;let s=t.vertexShader,a=t.fragmentShader;const l=cc(t),o=uc(t),u=hc(t),h=dc(t),d=fc(t),f=Ac(t),_=nc(r),v=i.createProgram();let p,c,w=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    `}),p=new Ns(_,v);return p.frustumCulled=!1,p.renderOrder=2,p.userData.stats={count:o,landCount:f},p}function Hr({color:n=1315866,opacity:e=.13,latStep:t=10,lngStep:A=10,latLimit:i=80,segments:r=128}={}){const s=[],a=new U,l=(d,f)=>{NA(d,f,1.0005,a),s.push(a.x,a.y,a.z)};for(let d=-i;d<=i;d+=t)for(let f=0;f<r;f++)l(d,-180+f/r*360),l(d,-180+(f+1)/r*360);for(let d=-180;d<180;d+=A)for(let f=0;f<r;f++)l(-90+f/r*180,d),l(-90+(f+1)/r*180,d);const o=new yt;o.setAttribute("position",new ot(new Float32Array(s),3));const u=new Nt({transparent:!0,depthWrite:!1,uniforms:{uColor:{value:new ze(n)},uOpacity:{value:e},uCamDir:{value:new U(0,0,1)},uFadeStart:{value:.1}},vertexShader:`
      uniform vec3 uCamDir;
      varying float vFacing;
      void main() {
        vFacing = dot(normalize(position), uCamDir);
    ...
    `}),h=new Is(o,u);return h.frustumCulled=!1,h.renderOrder=1,h}function Kc({color:n=1315866,opacity:e=.28,segments:t=512}={}){const A=new Float32Array(t*3);for(let l=0;l<t;l++){const o=l/t*Math.PI*2;A[l*3]=Math.cos(o),A[l*3+1]=Math.sin(o),A[l*3+2]=0}const i=new yt;i.setAttribute("position",new ot(A,3));const r=new Zi({color:n,transparent:!0,opacity:e,depthWrite:!1}),s=new Us(i,r);s.frustumCulled=!1,s.renderOrder=3;const a=new U(0,0,1);return s.userData.faceCamera=l=>{s.quaternion.setFromUnitVectors(a,l)},s}function Zc(n){const e=n.length,t=new Float32Array(e*2*3),A=new Float32Array(e*2*3),i=new Float32Array(e*2*3),r=new Float32Array(e*2),s=new Float32Array(e*2);for(let o=0;o<e;o++){const u=n[o],h=n[Math.max(o-1,0)],d=n[Math.min(o+1,e-1)],f=e===1?0:o/(e-1);for(let _=0;_<2;_++){const v=(o*2+_)*3;t[v]=u.x,t[v+1]=u.y,t[v+2]=u.z,A[v]=h.x,A[v+1]=h.y,A[v+2]=h.z,i[v]=d.x,i[v+1]=d.y,i[v+2]=d.z,r[o*2+_]=_===0?-1:1,s[o*2+_]=f}}const a=new Uint32Array((e-1)*6);for(let o=0;o<e-1;o++){const u=o*2,h=o*6;a[h]=u,a[h+1]=u+1,a[h+2]=u+2,a[h+3]=u+2,a[h+4]=u+1,a[h+5]=u+3}const l=new yt;return l.setAttribute("position",new ot(t,3)),l.setAttribute("aPrev",new ot(A,3)),l.setAttribute("aNext",new ot(i,3)),l.setAttribute("aSide",new ot(r,1)),l.setAttribute("aAlong",new ot(s,1)),l.setIndex(new ot(a,1)),l}const Qc=`
...
`;let kr=!1;function hu(n){if(kr)return;kr=!0;const e=n.createElement("style");e.textContent=uu,n.head.appendChild(e)}function du(n){hu(document);const e=document.createElement("div");return e.className="globe-pin-layer",Object.assign(e.style,{position:"absolute",inset:"0",pointerEvents:"none",zIndex:"40",overflow:"hidden"}),n.root.appendChild(e),e}class Wr{constructor(e,t){this.place=t,this.el=document.createElement("div"),this.el.className="globe-pin";const A=document.createElement("div");A.className="globe-pin__pill",A.textContent=t.label;const i=document.createElement("div");i.className="globe-pin__stem";const r=document.createElement("div");r.className="globe-pin__dot",this.el.append(A,i,r),this.pill=A,this.stem=i,this.dot=r,e.appendChild(this.el),this._amount=0,this.setAmount(0)}setAmount(e){return this._amount=Math.min(1,Math.max(0,e)),this}update(e){const t=e.project(this.place.lat,this.place.lng),A=this._amount;if(!t.visible||A<=.001){this.el.style.opacity="0";return}const i=Math.min(1,t.depth/.12);this.el.style.opacity=String(A*i),this.el.style.transform=`translate(${t.x}px, ${t.y}px)`;const r=1-A;this.pill.style.transform=`translateX(-50%) translateY(${r*10}px)`,this.pill.style.opacity=String(Math.min(1,A*1.4)),this.stem.style.transform=`scaleY(${A})`,this.dot.style.transform=`scale(${.4+.6*A})`}dispose(){this.el.remove()}}const fu=new Set(["IMG","SVG","PICTURE","VIDEO","CANVAS"]);function pu(n){return n.hasAttribute("data-type-atom")||fu.has(n.tagName.toUpperCase())?!0:n.textContent.trim()===""}function mu(n){const e=[];for(let t=1;t<=n.length;t++)e.push(t);return e}function _u(n){const e=[],t=/\S+/g;let A;for(;(A=t.exec(n))!==null;)e.push(A.index+A[0].length);return!e.length&&n.length&&e.push(n.length),e}function Xr(n,e,t){for(const A of Array.from(n.childNodes)){if(A.nodeType===Node.TEXT_NODE){const i=A.nodeValue;if(i.trim()===""||t.skip(A.parentElement))continue;const r=t.byWord?_u(i):mu(i);e.push({kind:"text",node:A,text:i,steps:r,cost:r.length});continue}A.nodeType===Node.ELEMENT_NODE&&(t.skip(A)||(pu(A)?e.push({kind:"atom",el:A,cost:t.atomCost,display:A.style.display}):Xr(A,e,t)))}}class gu{constructor(e,{skipSelector:t=null,byWord:A=!1}={}){this.el=e,this.byWord=A;const i=t?Array.from(e.querySelectorAll(t)):[],r=s=>s?i.some(a=>a===s||a.contains(s)):!1;this.units=[],Xr(e,this.units,{skip:r,byWord:A,atomCost:A?1:4}),this.total=this.units.reduce((s,a)=>s+a.cost,0),this.revealed=-1,this.reveal(0)}reveal(e){if(e===this.revealed)return;this.revealed=e;let t=e;for(const A of this.units){if(A.kind==="text"){const i=Math.max(0,Math.min(A.steps.length,t)),r=i===0?0:A.steps[i-1],s=A.text.slice(0,r);A.node.nodeValue!==s&&(A.node.nodeValue=s)}else{const i=t>=A.cost?A.display||"":"none";A.el.style.display!==i&&(A.el.style.display=i)}t-=A.cost}}get done(){return this.revealed>=this.total}}const vu=.6;function nA(n,e,t){const A=n.getAttribute(e);if(A===null||A.trim()==="")return t;const i=Number.parseFloat(A);return Number.isFinite(i)?i:t}const vi=n=>n<0?0:n>1?1:n,xu=n=>1-Math.pow(1-n,3),Mu=n=>1+(1.70158+1)*Math.pow(n-1,3)+1.70158*Math.pow(n-1,2);function Su(n){const e=n.hasAttribute("data-globe-pin"),t=(n.getAttribute("data-anim")||"fade").toLowerCase(),A={el:n,anchored:e,anim:t,lat:nA(n,"data-lat",0),lng:nA(n,"data-lng",0),offsetX:nA(n,"data-offset-x",0),offsetY:nA(n,"data-offset-y",0),inAt:nA(n,"data-in",0),outAt:n.hasAttribute("data-out")?nA(n,"data-out",1/0):null,dur:nA(n,"data-dur",vu),typeSpeed:nA(n,"data-type-speed",26),typer:null,typedCount:-1,hiddenByDisplay:!1,revealDisplay:""};if(t==="type"){const r=n.getBoundingClientRect();r.height&&(n.style.minHeight=`${Math.ceil(r.height)}px`),r.width&&(n.style.minWidth=`${Math.ceil(r.width)}px`,n.style.maxWidth="100%");const s=(n.getAttribute("data-type-by")||"word").toLowerCase()!=="char";A.typer=new gu(n,{skipSelector:n.getAttribute("data-type-skip")||null,byWord:s}),n.hasAttribute("data-type-speed")||(A.typeSpeed=s?4.5:26)}const i=typeof getComputedStyle=="function"?getComputedStyle(n):null;return i&&i.display==="none"&&(A.hiddenByDisplay=!0,A.revealDisplay=n.getAttribute("data-display")||"block"),n.style.willChange="transform, opacity",e&&(n.style.position="absolute",n.style.top="0",n.style.left="0"),A}class Eu{constructor(e,t=document){const A=t.querySelectorAll("[data-globe-cue], [data-globe-pin]");this.items=Array.from(A).map(Su),this.stage=e}get maxTime(){return this.items.reduce((e,t)=>{const A=t.outAt!==null?t.outAt+t.dur:t.inAt+t.dur,i=t.typer?t.inAt+t.typer.total/t.typeSpeed:0;return Math.max(e,A,i)},0)}update(e,t){for(const A of this.items)this._updateItem(A,e,t)}_updateItem(e,t,A){const i=vi((t-e.inAt)/e.dur),r=e.outAt===null?0:vi((t-e.outAt)/e.dur),s=i*(1-r),a=e.el;if(e.anim==="type"&&this._type(e,t),s<=.001){a.style.opacity="0",a.style.pointerEvents="none",e.hiddenByDisplay&&(a.style.display="none");return}e.hiddenByDisplay&&a.style.display!==e.revealDisplay&&(a.style.display=e.revealDisplay);let l=s,o=e.offsetX,u=e.offsetY,h=1;if(e.anim==="rise"?u+=(1-xu(i))*16:e.anim==="pop"?(h=.86+.14*Mu(i),l=vi(i*1.6)*(1-r)):e.anim==="type"&&(l=i>0?1-r:0),e.anchored){const d=A.project(e.lat,e.lng);if(!d.visible){a.style.opacity="0",e.hiddenByDisplay&&(a.style.display="none");return}const f=Math.min(1,d.depth/.12);l*=f,a.style.transform=`translate(${d.x+o}px, ${d.y+u}px) translate(-50%, -100%) scale(${h})`}else a.style.transform=`translate(${o}px, ${u}px) scale(${h})`;a.style.opacity=String(l),a.style.pointerEvents=l>.9?"":"none"}_type(e,t){if(!e.typer)return;const A=t-e.inAt,i=A<=0?0:Math.min(e.typer.total,Math.floor(A*e.typeSpeed));i!==e.typedCount&&(e.typedCount=i,e.typer.reveal(i),e.el.dataset.typing=e.typer.done?"0":"1")}}const qr=[{selector:".hero1_profile_choice_wrap",in:.2,anim:"rise"},{selector:".hero1_profile_choice_text_wrap",in:.6,out:6.2,dur:.45,anim:"type",typeSpeed:4.5},{selector:".hero1_profile_search_wrap",in:.2,out:6.2,dur:.45,anim:"fade"},{selector:".hero1_profile_route_wrap",in:3.2,anim:"rise"},{selector:".hero1_profile_choice_check",in:6.7,anim:"pop",display:"flex"},{selector:".hero1_profile_choice_confirm",create:{cloneFrom:".hero1_profile_choice_text",insertAfter:".hero1_profile_choice_check",text:"No early mornings"},in:7,anim:"type",typeSpeed:4.5,display:"block",optional:!0},{selector:".hero1_profile_choice_line",in:7.6,stagger:1.6,anim:"type",typeSpeed:4.5,display:"flex",optional:!0}],yu=3,Tu={in:"data-in",out:"data-out",dur:"data-dur",anim:"data-anim",typeSpeed:"data-type-speed",typeSkip:"data-type-skip",typeBy:"data-type-by",display:"data-display",lat:"data-lat",lng:"data-lng",offsetX:"data-offset-x",offsetY:"data-offset-y"};function wu(n,e){const{cloneFrom:t,appendTo:A,insertAfter:i,text:r}=n.create,s=A?e.querySelector(A):null,a=i?e.querySelector(i):null;if(!s&&!a)return null;const l=t?e.querySelector(t):null,o=l?l.cloneNode(!1):(e.ownerDocument||document).createElement("div");o.removeAttribute("data-globe-cue"),o.removeAttribute("data-globe-pin");for(const u of n.selector.split(".").filter(Boolean))o.classList.add(u);return r!==void 0&&(o.textContent=r),o.style.display="none",a&&a.parentNode?a.parentNode.insertBefore(o,a.nextSibling):s.appendChild(o),o}function bu(n=qr,e=document){const t=[],A=[],i=[];for(const r of n){let s=e.querySelectorAll(r.selector);if(!s.length&&r.create){const l=wu(r,e);l&&(s=[l],i.push(r.selector))}if(!s.length){r.optional||A.push(r.selector);continue}let a=0;for(const l of s){const o=r.stagger?a*r.stagger:0;a++;const u=r.lat!==void 0?"data-globe-pin":"data-globe-cue";!l.hasAttribute("data-globe-cue")&&!l.hasAttribute("data-globe-pin")&&l.setAttribute(u,"");for(const[h,d]of Object.entries(Tu)){if(r[h]===void 0||l.hasAttribute(d))continue;const f=h==="in"||h==="out"?Math.round((r[h]+o)*1e3)/1e3:r[h];l.setAttribute(d,String(f))}t.push(r.selector)}}return A.length&&console.warn("[globe] sequence selectors matched nothing: "+A.join(", ")+" - a class was probably renamed in Webflow"),{applied:t,missing:A,created:i}}const Yr={linear:n=>n,outCubic:n=>1-Math.pow(1-n,3),inOutCubic:n=>n<.5?4*n*n*n:1-Math.pow(-2*n+2,3)/2,outBack:n=>1+(1.70158+1)*Math.pow(n-1,3)+1.70158*Math.pow(n-1,2)},Ru=[{track:"originPin",at:.15,dur:.75,from:0,to:1,ease:"outBack"},{track:"arcDraw",at:.65,dur:1.5,from:0,to:1,ease:"inOutCubic"},{track:"destPin",at:2.05,dur:.75,from:0,to:1,ease:"outBack"},{track:"dropHead",at:2.6,dur:1.8,from:0,to:1,ease:"inOutCubic"}];class Pu{constructor({route:e,originPin:t,destPin:A,beats:i=Ru,offset:r=0,loop:s=!1,loopDelay:a=2.5}){this.route=e,this.originPin=t,this.destPin=A,this.offset=r,this.beats=r?i.map(l=>({...l,at:l.at+r})):i,this.loop=s,this.loopDelay=a,this.time=0,this.playing=!1,this.duration=this.beats.reduce((l,o)=>Math.max(l,o.at+o.dur),0),this.values={originPin:0,arcDraw:0,dropHead:0,destPin:0},this._apply()}play(){return this.playing=!0,this}pause(){return this.playing=!1,this}restart(){return this.time=0,this.playing=!0,this}seek(e){return this.time=e,this._sample(),this._apply(),this}complete(){return this.seek(this.duration)}advance(e){if(!this.playing)return this;this.time+=e;const t=this.duration+(this.loop?this.loopDelay:0);return this.time>t&&(this.loop?this.time=0:this.time=this.duration),this._sample(),this._apply(),this}_sample(){for(const e of this.beats){const t=(this.time-e.at)/e.dur,A=Math.min(1,Math.max(0,t)),i=Yr[e.ease]||Yr.linear;this.values[e.track]=e.from+(e.to-e.from)*i(A)}}_apply(){const e=this.values;this.route.setProgress(e.arcDraw),this.route.setHead(e.dropHead),this.originPin&&this.originPin.setAmount(e.originPin),this.destPin&&this.destPin.setAmount(e.destPin)}}function Du(){return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const $r="#globe-root";function jr(){const n=document.querySelector($r);if(!n){console.warn(`[globe] no ${$r} on the page`);return}if(n.dataset.globeMounted)return;n.dataset.globeMounted="1";const e=ou(n),t=au(n),A=new su(n,e),i=t[0],r=t[1];let s=null;if(i&&r){const l=A.addRoute(i,r),o=du(A),u=new Wr(o,i),h=new Wr(o,r);s=new Pu({route:l,originPin:u,destPin:h,offset:e.globeStart||yu,loop:n.hasAttribute("data-globe-loop")}),bu(qr,document);const d=new Eu(A,document);d.maxTime>s.duration&&(s.duration=d.maxTime),A.onFrame((f,_)=>{s.advance(_.deltaSeconds),u.update(_),h.update(_),d.update(s.time,_)}),window.__globeOverlays=d,Du()?s.complete():s.play()}A.start(),(new URLSearchParams(location.search).has("debug")||n.hasAttribute("data-globe-debug"))&&cu(A),window.__globe={stage:A,layout:e,places:t,flow:s}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",jr,{once:!0}):jr()})();
