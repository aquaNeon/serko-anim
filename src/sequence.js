...
export const STACK = {
  ...
  drawDur: 0.5,
  cards: [
    { at: 0.9, kind: 'prompt', from: '.hero1_profile_choice_text_wrap' },
    { at: 7.0, kind: 'pref', text: 'No early mornings' },
    { at: 9.1, kind: 'pref', text: 'Premium economy' },
    { at: 11.7, kind: 'prompt', from: '.hero1_profile_choice_hotel' },
    { at: 15.2, kind: 'pref', text: 'Walkable location' },
    { at: 17.1, kind: 'pref', text: 'Mid-range price' },
  ],
}
